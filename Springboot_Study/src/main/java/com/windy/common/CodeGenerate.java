...
public class CodeGenerate {
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(
                        "jdbc:mysql://localhost:3306/studentdb?useUnicode=true&characterEncoding=UTF-8&useSSL=false",
                        "root",
                        "123456")
...
//                          .enableSwagger() // 是否启用swagger注解
                ...
                .packageConfig(builder -> {
                    builder
                            ...
                            .xml("mapper.xml")
                            .pathInfo(Collections.singletonMap(OutputFile.xml, projectPath + "/src/main/resources/mapper/xml")).build();
                })
