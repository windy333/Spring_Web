        ...
        <div class="panel-body">
            <form action="book_edit_do.html?bookId=${detail.bookId}" method="post" id="addbook" >
                ...
                <div class="input-group" style="margin-top: 10px">
                    ...
                    <textarea class="form-control" name="introduction" id="introduction">${detail.introduction}</textarea>
                </div>
                <div class="input-group" style="margin-top: 10px">
                ...
                <input type="submit" value="确定" class="btn btn-success btn-sm" class="text-left" style="margin-top: 20px;width: 60px;margin-left: 320px">
                <script>
